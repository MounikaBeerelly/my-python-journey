...
timedeltaObject = pd.Timedelta(weeks = 3, days = 2, hours = 5, minutes = 20, seconds = 45, milliseconds = 100, microseconds = 10000, nanoseconds = 2343)
...
The format of the calendar returned is:  23 days 05:20:45.110002343
