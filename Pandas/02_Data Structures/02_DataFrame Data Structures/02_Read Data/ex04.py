...
empDataShape = empDataFrame.shape

print("\nThe number of Dimensions of the Employee dataframe are: " + str(empDataFrame.ndim), end = "\n")
print("\nThe Shape of the Employee dataframe is: " + str(empDataShape), end = "\n")
print("\nThe number of Records loaded into the Employee dataframe is: " + str(empDataShape[0]) + " records.", end = "\n")
print("\nThe number of Columns identified in the Employee dataframe is: " + str(empDataShape[1]) + " columns.", end = "\n")
print("\nThe total number of data elements found in the Employee dataframe are: " + str(empDataFrame.size), end = "\n")
...
The number of Dimensions of the Employee dataframe are: 2

The Shape of the Employee dataframe is: (14, 8)

The number of Records loaded into the Employee dataframe is: 14 records.

The number of Columns identified in the Employee dataframe is: 8 columns.

The total number of data elements found in the Employee dataframe are: 112
"""