...
searchValue = int(input("\nPlease enter the Index Number to retrieve the record: "))
...
Please enter the Index Number to retrieve the record: 4

The Details of the employee with Index number: 4 are..
ENAME          MARTIN
JOB          SALESMAN
MGR            7698.0
HIREDATE    28-Sep-81
