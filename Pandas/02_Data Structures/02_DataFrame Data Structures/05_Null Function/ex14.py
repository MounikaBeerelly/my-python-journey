...
nullFillRule = input("\nDo you want to drop the null value columns (Y OR NO): ")

if nullFillRule == 'Y' or nullFillRule == 'y' :
   print("\n", empDataFrame.dropna(axis = 1))
else :
    print("\n", empDataFrame)
...
Do you want to drop the null value columns (Y OR NO): y

     EMPNO   ENAME        JOB   HIREDATE   SAL  DEPTNO
0    7369   SMITH      CLERK  17-Dec-80   800      20
1    7499   ALLEN   SALESMAN  20-Feb-81  1600      30
2    7521    WARD   SALESMAN  22-Feb-81  1250      30
3    7566   JONES    MANAGER   2-Apr-81  2975      20
4    7654  MARTIN   SALESMAN  28-Sep-81  1250      30
5    7698   BLAKE    MANAGER   1-May-81  2850      30
6    7782   CLARK    MANAGER   9-Jun-81  2450      10
7    7788   SCOTT    ANALYST   9-Dec-82  3000      20
8    7839    KING  PRESIDENT  17-Nov-81  5000      10
9    7844  TURNER   SALESMAN   8-Sep-81  1500      30
10   7876   ADAMS      CLERK  12-Jan-83  1100      20
11   7900   JAMES      CLERK   3-Dec-81   950      30
12   7902    FORD    ANALYST   3-Dec-81  3000      20
