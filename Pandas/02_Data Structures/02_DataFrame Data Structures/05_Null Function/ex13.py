...
nullFillRule = input("\nDo you want to drop the null value records (Y OR NO): ")

if nullFillRule == 'Y' or nullFillRule == 'y' :
   print("\n", empDataFrame.dropna(how='any'))
   #print("\n", empDataFrame.dropna(how='all'))
else :
    print("\n", empDataFrame)
...
Do you want to drop the null value records (Y OR NO): y
