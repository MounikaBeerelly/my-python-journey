...
statusColumn = input("\nPlease enter the column name on which the missing values should be identified: ")

queryRule = int(input("\nDo you want to display the records with NULL OR NOTNULL status (1. NULL, 2.NOTNULL): "))
...
if queryRule == 1 :
    ...
    print("\nIn-proper input identified...", end="\n")
...
Please enter the column name on which the missing values should be identified: COMM

Do you want to display the records with NULL OR NOTNULL status (1. NULL, 2.NOTNULL): 1
