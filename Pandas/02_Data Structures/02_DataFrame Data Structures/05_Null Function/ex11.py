...
if nullFillRule == 'Y' or nullFillRule == 'y' :
   print("\n", empDataFrameCopy.fillna(method="bfill"))
else :
    print("\n", empDataFrame)
...
C:\Practice\my-python-journey\Pandas\02_Data Structures\02_DataFrame Data Structures\05_Null Function\ex11.py:18: FutureWarning: DataFrame.fillna with 'method' is deprecated and will raise in a future version. Use obj.ffill() or obj.bfill() instead.
  print("\n", empDataFrameCopy.fillna(method="bfill"))

     EMPNO   ENAME        JOB     MGR   HIREDATE   SAL    COMM  DEPTNO
0    7369   SMITH      CLERK  7902.0  17-Dec-80   800   300.0      20
1    7499   ALLEN   SALESMAN  7698.0  20-Feb-81  1600   300.0      30
2    7521    WARD   SALESMAN  7698.0  22-Feb-81  1250   500.0      30
3    7566   JONES    MANAGER  7839.0   2-Apr-81  2975  1400.0      20
4    7654  MARTIN   SALESMAN  7698.0  28-Sep-81  1250  1400.0      30
5    7698   BLAKE    MANAGER  7839.0   1-May-81  2850     0.0      30
6    7782   CLARK    MANAGER  7839.0   9-Jun-81  2450     0.0      10
7    7788   SCOTT    ANALYST  7566.0   9-Dec-82  3000     0.0      20
8    7839    KING  PRESIDENT  7698.0  17-Nov-81  5000     0.0      10
9    7844  TURNER   SALESMAN  7698.0   8-Sep-81  1500     0.0      30
10   7876   ADAMS      CLERK  7788.0  12-Jan-83  1100     NaN      20
11   7900   JAMES      CLERK  7698.0   3-Dec-81   950     NaN      30
12   7902    FORD    ANALYST  7566.0   3-Dec-81  3000     NaN      20
