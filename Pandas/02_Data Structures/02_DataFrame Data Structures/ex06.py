...
empData= {
    ...
    'hiredate' : ['17-Dec-80', '20-Feb-81', '22-Feb-81', '2-Apr-81', '28-Sep-81', '1-May-81', '9-Jun-81', '9-Dec-82', '17-Nov-81', '8-Sep-81', '12-Jan-83', '3-Dec-81', '3-Dec-81', '23-Jan-82'],
    'sal' : [800, 1600, 1250, 2975, 1250, 2850, 2450, 3000, 5000, 1500, 1100, 950, 3000, 1300],
    'comm' : [np.nan, 300, 500, np.nan, 1400, np.nan, np.nan, np.nan, np.nan, np.nan, 0, np.nan, np.nan, np.nan],
    'deptno' : [20, 30, 30, 20, 30, 30, 10, 20, 10, 30, 20, 30, 20, 10]
}

empDataFrame = pd.DataFrame(empData, index = ['RowID1', 'RowID2', 'RowID3', 'RowID4', 'RowID5', 'RowID6', 'RowID7', 'RowID8', 'RowID9', 'RowID10', 'RowID11', 'RowID12', 'RowID13', 'RowID14'])

print("\nPrinting the employees Data frame, loaded with Row labels and column labels with missing values as NaN..", end="\n")
...
Output:
======
Printing the employees Data frame, loaded with Row labels and column labels with missing values as NaN..
         Empno EmpName     EmpJob     mgr   hiredate   sal    comm  deptno
