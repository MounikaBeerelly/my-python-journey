...
print("\nThe total records of employees: ", empDataFrame["EMPNO"].count())
print("\nThe total Investments of Salaries: ", empDataFrame["SAL"].sum())
print("\nThe Highest Investments of Salaries: ", empDataFrame["SAL"].max())
print("\nThe Lowest Investments of Salaries: ", empDataFrame["SAL"].min())
print("\nThe Average Investments of Salaries: ", empDataFrame["SAL"].mean())
print("\nThe total Investments of Commissions: ", empDataFrame["COMM"].sum())
print("\nThe Highest Investments of Commissions: ", empDataFrame["COMM"].max())
print("\nThe Lowest Investments of Commissions: ", empDataFrame["COMM"].min())
print("\nThe Average Investments of Commissions: ", empDataFrame["COMM"].mean())
...
The total records of employees:  14

The total Investments of Salaries:  29025

The Highest Investments of Salaries:  5000

The Lowest Investments of Salaries:  800

The Average Investments of Salaries:  2073.214285714286

The total Investments of Commissions:  2200.0

The Highest Investments of Commissions:  1400.0

The Lowest Investments of Commissions:  0.0

The Average Investments of Commissions:  550.0
"""