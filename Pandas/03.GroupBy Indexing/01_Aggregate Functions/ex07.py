...
empDeptSalAvg = empDataFrame.groupby("DEPTNO")["SAL"].mean()

print("\nThe average Investment of Salaries department wise: ", empDeptSalAvg)
...
The average Investment of Salaries department wise:  DEPTNO
10    2916.666667
20    2175.000000
30    1566.666667
