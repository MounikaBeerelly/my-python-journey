...
empDeptGroup = empDataFrame.groupby("JOB")

print("\n", empDeptGroup.aggregate({"SAL" : ['sum', 'min', 'max', 'mean']}))
...
13   7934  MILLER      CLERK  7782.0  23-Jan-82  1300     NaN      10
            ...
            sum   min   max         mean
JOB
ANALYST    6000  3000  3000  3000.000000
CLERK      4150   800  1300  1037.500000
MANAGER    8275  2450  2975  2758.333333
PRESIDENT  5000  5000  5000  5000.000000
SALESMAN   5600  1250  1600  1400.000000
