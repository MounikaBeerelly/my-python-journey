...
empGroupData = empDataFrame.groupby(["DEPTNO"], sort = True)

inGetGroup = int(input("\nPlease give the group to be filtered: "))

groupData = empGroupData.get_group((inGetGroup,))

print(f"The current department group of data is: (Deptno : {inGetGroup}) ", end="\n")
print("\n", groupData, end="\n")
...
Please give the group to be filtered: 20
The current department group of data is: (Deptno : 20)
