...
print("\nThe number of employees matching to year 1981 are : ", empDataFrame[empDataFrame['HIREDATE'].dt.year == 1981]["EMPNO"].count(), end="\n")
...
The number of employees matching to year 1981 are :  10
"""