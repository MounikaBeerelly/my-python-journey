...
print("\nPlaying the audio file is in the format of .wav")
print("---------------------------------------------------------", end="\n")

audioPath = r"C:\Practice\my-python-journey\DataSets\AudioFiles\sample.wav"

print("\nLoading the audio file.. Please wait..", end="\n")

loadMusicFile = AudioSegment.from_file(file = audioPath, format = "wav")
