...
for extractedName in extractedFiles :
    if fnmatch.fnmatch(extractedName, searchPattern) :
...
Please enter the search pattern including wild cards if any : *.MD

The given pattern for searching the files is :  *.MD

File Name : FileOperations.md
