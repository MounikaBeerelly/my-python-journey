...
print("\nLoading the Pre-Trained Haar Cascade Classifier for Face Detection..", end="\n")

faceCascade = cv2.CascadeClassifier(cv2.data.haarcascades + 'haarcascade_frontalface_default.xml')

print("\nCreating an object for capturing the video..", end="\n")

captureVideo = cv2.VideoCapture(r"C:\Practice\my-python-journey\10_File Operations\09_VideoFileManagement\Videos\Video05.mp4")
...
outvideoFile = cv2.VideoWriter(r"C:\Practice\my-python-journey\10_File Operations\09_VideoFileManagement\savedVideos\facedetectionVideo.mp4", videoFourCC, 20.0, (windowWidth, windowHeight))
...
while (captureVideo.isOpened()) :
    ...
    if frameReturned == True :
        ...
        detectFaces = faceCascade.detectMultiScale(resizedFrame, scaleFactor = 1.1, minNeighbors = 5, minSize = (30,30))
        
        for (x,y, w,h) in detectFaces :
            cv2.rectangle(resizedFrame, (x,y), (x+w, y+h), (0,0,255), 2)
