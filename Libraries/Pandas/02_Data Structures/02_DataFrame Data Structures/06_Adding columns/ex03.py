...
deptDataFrameNew = deptDataFrame.assign(deptState = ["Financial Head Quarteres", "Think Tank Center", "Market Analysis Center", "Administrative Head Quarters"])

print("\n", deptDataFrameNew, end="\n")
