...
empColumnLabels.sort_values(by = ["SAL"], inplace = True)
...
startRange = int(input("\nPlease provide the starting salary range: "))
endRange = int(input("\nPlease provide the ending salary range: "))

empRecord = empColumnLabels[(empColumnLabels["SAL"] >= startRange) & (empColumnLabels["SAL"] <= endRange)]

print("\nThe Details of the employees from salary ranges: " + str(startRange) + " To " + str(endRange) + " are..", end="\n")
print(empRecord)
...
Please provide the starting salary range: 950

Please provide the ending salary range: 1250

The Details of the employees from salary ranges: 950 To 1250 are..
        ENAME       JOB     MGR   HIREDATE   SAL    COMM  DEPTNO
EMPNO
7900    JAMES     CLERK  7698.0   3-Dec-81   950     NaN      30
7876    ADAMS     CLERK  7788.0  12-Jan-83  1100     NaN      20
