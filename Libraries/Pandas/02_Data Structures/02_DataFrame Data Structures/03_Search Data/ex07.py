...
searchValue = int(input("\nPlease enter the Index Number upto which you want to search the data: "))

empRecord = empDataFrame.iloc[:searchValue]

print("\nThe Details of the employee with Index number: " + str(searchValue) + " are..", end="\n")
print(empRecord)
...
Please enter the Index Number upto which you want to search the data: 5

The Details of the employee with Index number: 5 are..
        ENAME       JOB     MGR   HIREDATE   SAL    COMM  DEPTNO
EMPNO                                         
7369    SMITH     CLERK  7902.0  17-Dec-80   800     NaN      20
7499    ALLEN  SALESMAN  7698.0  20-Feb-81  1600   300.0      30
