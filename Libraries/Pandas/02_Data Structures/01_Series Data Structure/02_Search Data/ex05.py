...
while queryState :
    ...
    print(empnoSeries)
    headValue = int(input("\nPlease enter the number of the elements to be displayed from top: "))
    
    if headValue <= empnoSeries.size :
       print("\nFound the elements.. Printing the values..", end="\n")
       print("\nThe employee numbers found are... \n\n", str(empnoSeries.head(headValue)), end="\n")
    else:
...
Please enter the number of the elements to be displayed from top: 4
