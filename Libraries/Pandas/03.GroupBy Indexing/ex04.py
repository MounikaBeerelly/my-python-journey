...
empDeptJobGroup = empDataFrame.groupby(["DEPTNO", "JOB"])

print("\n")
for indexDeptJob, empGroupData in empDeptJobGroup :
    deptno, job = indexDeptJob
    print(f"The current department with Job group of data is: (Deptno : {int(deptno)}, Job: {job}) ", end="\n")
    print("\n", empGroupData, end="\n")
...
The current department with Job group of data is: (Deptno : 10, Job: CLERK)

     EMPNO   ENAME    JOB     MGR   HIREDATE   SAL  COMM  DEPTNO
13   7934  MILLER  CLERK  7782.0  23-Jan-82  1300   NaN      10
The current department with Job group of data is: (Deptno : 10, Job: MANAGER)

    EMPNO  ENAME      JOB     MGR  HIREDATE   SAL  COMM  DEPTNO
6   7782  CLARK  MANAGER  7839.0  9-Jun-81  2450   NaN      10
The current department with Job group of data is: (Deptno : 10, Job: PRESIDENT)

    EMPNO ENAME        JOB  MGR   HIREDATE   SAL  COMM  DEPTNO
8   7839  KING  PRESIDENT  NaN  17-Nov-81  5000   NaN      10
The current department with Job group of data is: (Deptno : 20, Job: ANALYST)

     EMPNO  ENAME      JOB     MGR  HIREDATE   SAL  COMM  DEPTNO
7    7788  SCOTT  ANALYST  7566.0  9-Dec-82  3000   NaN      20
12   7902   FORD  ANALYST  7566.0  3-Dec-81  3000   NaN      20
The current department with Job group of data is: (Deptno : 20, Job: CLERK)

     EMPNO  ENAME    JOB     MGR   HIREDATE   SAL  COMM  DEPTNO
0    7369  SMITH  CLERK  7902.0  17-Dec-80   800   NaN      20
10   7876  ADAMS  CLERK  7788.0  12-Jan-83  1100   NaN      20
The current department with Job group of data is: (Deptno : 20, Job: MANAGER)

    EMPNO  ENAME      JOB     MGR  HIREDATE   SAL  COMM  DEPTNO
3   7566  JONES  MANAGER  7839.0  2-Apr-81  2975   NaN      20
The current department with Job group of data is: (Deptno : 30, Job: CLERK)

     EMPNO  ENAME    JOB     MGR  HIREDATE  SAL  COMM  DEPTNO
11   7900  JAMES  CLERK  7698.0  3-Dec-81  950   NaN      30
The current department with Job group of data is: (Deptno : 30, Job: MANAGER)

    EMPNO  ENAME      JOB     MGR  HIREDATE   SAL  COMM  DEPTNO
5   7698  BLAKE  MANAGER  7839.0  1-May-81  2850   NaN      30
The current department with Job group of data is: (Deptno : 30, Job: SALESMAN)
