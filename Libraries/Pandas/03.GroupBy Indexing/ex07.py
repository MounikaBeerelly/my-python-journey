...
inGetFilter01 = int(input("\nPlease give the group to be filtered: "))
inGetFilter02 = input("\nPlease give the group filter to be filtered: ")

print("\n", empDeptJobGroup.get_group((inGetFilter01, inGetFilter02)))
...
Please give the group to be filtered: 30

Please give the group filter to be filtered: MANAGER
