...
print("\nHere we are calling the \"del()\" method available in Python for deleting the object...", end="\n")
del sampleObject01
...
Here we are calling the "del()" method available in Python for deleting the object...
