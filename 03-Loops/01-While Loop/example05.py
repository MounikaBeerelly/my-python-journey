...
Calculate the sum of all the series of numbers and mean of the sum.
...
startRange =  endRange = totalsum = countValues = 0
...
while(startRange <= endRange):
    ...
    totalsum = totalsum + startRange
    countValues = countValues + 1
    startRange = startRange + 1

print("\nthe total given values are:", countValues,end="\n")

print("\nThe sum of the series of the numbers from %d To %d is: %d"%(startRange,endRange,totalsum),end="\n")
print("\nThe mean of the series of the numbers from %d To %d is: %d"%(startRange,endRange,totalsum/countValues),end="\n")
