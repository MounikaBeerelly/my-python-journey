...
1. start: (Optional) Starting a value of the sequence. Default is 0
2. stop: (required) End value of the sequence (exclusive)
3. step: (optional) Difference between consecutive values. Default is 1
4. dtype: (optional) Specifies the desired data type of the array. If not provided, it is inferred
